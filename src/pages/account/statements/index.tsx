...
import {Dropdown, DropdownButton, DropdownItem, DropdownMenu,} from "@src/components/custom/dropdown/dropdown";
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-x-3">
                        <div className="card">
                            <div className="text-center card-body">
                                ...
                                <p className="text-gray-500 dark:text-dark-500">Net Earnings</p>
                            </div>
                        </div>
                        <div className="card">
                            <div className="text-center card-body">
