        ...
        <div className="flex items-center justify-center size-12 shrink-0">
          {icon === true ? (
            ...
            <Smartphone
              ...
              className="text-gray-500 fill-gray-100 dark:text-dark-500 dark:fill-dark-850"
            ></Smartphone>
          )}
        </div>
        <div className="grow">
...
const AccountLogs: NextPageWithLayout = () => {
  ...
  return (
    <React.Fragment>
      ...
      >
        <Tab
          icon={<UserRound className="inline-block ltr:mr-1 rtl:ml-1 size-4" />}
          label="Account"
          path="/page/account-settings"
        ></Tab>
        <Tab
          icon={
            <ShieldCheck className="inline-block ltr:mr-1 rtl:ml-1 size-4" />
          }
          label="Security"
          path="/page/account-security"
        ></Tab>
        <Tab
          icon={<Gem className="inline-block ltr:mr-1 rtl:ml-1 size-4" />}
          label="Billing & Plans"
          path="/page/account-billing-plan"
        ></Tab>
        <Tab
          icon={<Bell className="inline-block ltr:mr-1 rtl:ml-1 size-4" />}
          label="Notification"
          path="/page/account-notification"
        ></Tab>
        <Tab
          icon={<ListTree className="inline-block ltr:mr-1 rtl:ml-1 size-4" />}
          label="Statements"
          path="/page/account-statements"
        ></Tab>
        <Tab
          icon={<LogOut className="inline-block ltr:mr-1 rtl:ml-1 size-4" />}
          label="Logs"
