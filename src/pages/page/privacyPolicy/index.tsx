...
import pr from "@assets/images/others/pr.png";
...
const PrivacyPolicy: NextPageWithLayout = () => {
  ...
  return (
    <React.Fragment>
      <BreadCrumb title="Privacy Policy" subTitle="Pages" />
        ...
        <div className="col-span-12 xl:col-span-8 xl:col-start-3">
          <div className="card">
            <div className="card-body">
              ...
              <ul className="mb-3 space-y-2 list-inside list-circle">
                <li>
                  <span className="font-semibold">Personal Information:</span>{" "}
                  Such as your name, email address, phone number, and other
                  contact information provided voluntarily when you interact
                  with us through our website, applications, or other
                  communication channels.
                </li>
                <li>
                  <span className="font-semibold">Usage Data:</span> Information
                  about how you interact with our services, including your IP
                ...
                <li>
                  ...
                  technologies to enhance your experience and gather information
              ...
              <ul className="mb-3 space-y-2 list-inside list-circle">
                ...
                <li>
                  To analyze usage trends and improve the functionality of our
              ...
              <div className="py-5">
                <img src={pr} alt="primg" className="mx-auto max-h-44" />
              </div>
              <p className="mb-2 text-gray-500 dark:text-dark-500">
              ...
              <p className="mb-2 text-gray-500 dark:text-dark-500">
                ...
                system activity, and the date, time, and referrer URL of your
                request.
              </p>
              <p className="mb-3 text-gray-500 dark:text-dark-500">
                We collect this information when a Google service on your device
                contacts our servers — for example, when you install an app from
                the Play Store or when a service checks for automatic updates.
                If you’re using an Android device with Google apps, your device
                periodically contacts Google servers to provide information
                about your device and connection to our services. This
                information includes things like your device type and carrier
                name, crash reports, which apps you've installed, and, depending
                on your device settings, other information about how you’re
                using your Android device.
              </p>
              <h6 className="mb-2">Information Sharing</h6>
              <p className="mb-3 text-gray-500 dark:text-dark-500">
              ...
              <h6 className="mb-2">Data Security</h6>
              <p className="mb-3 text-gray-500 dark:text-dark-500">
                We implement appropriate technical and organizational measures
                to protect the security of your personal information and prevent
                unauthorized access, disclosure, alteration, or destruction.
              </p>
              <h6 className="mb-2">Your Choices</h6>
              <p className="mb-3 text-gray-500 dark:text-dark-500">
              ...
              <h6 className="mb-2">Children's Privacy</h6>
              <p className="mb-3 text-gray-500 dark:text-dark-500">
              ...
              <div className="flex justify-end gap-2 mt-5">
                ...
                <Link to="#!" className="border-dashed btn btn-dashed-red">
                  I Disagree
                </Link>
              </div>
            </div>
