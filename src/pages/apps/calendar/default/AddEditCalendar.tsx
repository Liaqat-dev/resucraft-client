  ...
  useEffect(() => {
    if (editMode && currentCalendar) {
      ...
      Object.keys(currentCalendar).forEach((key) => {
        setValue(
          key as keyof typeof currentCalendar as any,
          currentCalendar[key as keyof typeof currentCalendar],
        );
      });
              ...
              <div className="grid grid-cols-12 gap-space">
                ...
                <div className="col-span-4">
                  ...
                  <div className="relative group/form right">
                    ...
                    <button className="absolute inset-y-0 flex items-center text-gray-500 dark:text-dark-500 ltr:left-3 rtl:right-3 focus:outline-none">
                ...
                <div className="col-span-4">
                  ...
                  {errors.eventTime && (
                    <span className="text-red-500">
                      {typeof errors.eventTime?.message === "string"
                ...
                <div className="col-span-12">
                  ...
                  {errors.extendedProps && errors.extendedProps.location && (
                    <input
                      type="text"
                      id="locationInput"
                      className="form-input"
