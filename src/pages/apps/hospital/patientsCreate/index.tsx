...
const PatientsCreate: NextPageWithLayout = () => {
  ...
  useEffect(() => {
    document.title =
      "Create Patient | Domiex - React TS Admin & Dashboard Template";
  }, []);
  ...
  const submitForm = (data: Patients) => {
    if (editMode && currentPatients) {
      const updatedPatients: Patients = { ...data, _id: currentPatients._id };
      dispatch(editPatientsData(updatedPatients));
      navigate("/apps/hospital/patients-lists");
    } else {
      const newPatients = { ...data, _id: patients.length + 1 };
            ...
            <div className="grid grid-cols-12 gap-space">
              ...
              <div className="col-span-12 md:col-span-6">
                ...
                <div className="flex form-input">
                  <select
                    id="phoneNumber"
                    className="bg-transparent outline-none cursor-pointer dark:bg-dark-900 ltr:pl-3 rtl:pr-3"
                  ...
                  <input
                    type="text"
                    className="w-full p-3 bg-transparent border-gray-200 outline-none ltr:ml-3 rtl:mr-3 ltr:border-l-2 dark:border-dark-800 rtl:border-r-2"
