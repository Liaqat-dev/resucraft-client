...
import AddEditHolidays from "@src/views/apps/hospital/staffListHoliday/addEditHolidays";
...
const StaffHolidays: NextPageWithLayout = () => {
  ...
  useEffect(() => {
    document.title = "Holidays | Domiex - React TS Admin & Dashboard Template";
  }, []);
