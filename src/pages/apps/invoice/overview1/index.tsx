...
const Overview1: NextPageWithLayout = () => {
    ...
    <React.Fragment>
      ...
      >
        <div className="card print:border-0 print:shadow-none">
          <div className="md:p-10 card-body print:p-0">
              ...
              <div className="space-y-2 ltr:text-right rtl:text-left">
                <p className="text-gray-500 dark:text-dark-500">
                  ...
                  <Link
                    ...
                    className="font-semibold text-gray-800 dark:text-dark-50"
                  >
                  ...
                  <tbody>
                    ...
                    <tr className="whitespace-nowrap">
                      ...
                      <th className="!border-0 text-primary-600">
                        ${clientInvoice?.totalAmount.toFixed(2)}
                      </th>
                    </tr>
                  </tbody>
                </table>
