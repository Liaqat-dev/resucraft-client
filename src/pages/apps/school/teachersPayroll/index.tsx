...
import { Teacher } from "@src/dtos/layout";
...
const TeachersPayroll: NextPageWithLayout = () => {
  ...
  useEffect(() => {
    document.title = "Payroll | Domiex - React TS Admin & Dashboard Template";
  }, []);
            ...
            <div className="flex flex-wrap justify-between gap-4">
              <div>
                <div className="relative group/form grow">
                  ...
                  />
                  <button className="absolute inset-y-0 flex items-center ltr:left-3 rtl:right-3 lt:group-[&.right]/form:right-3 rtl:group-[&.right]/form:left-3 ltr:group-[&.right]/form:left-auto rtl:group-[&.right]/form:right-auto focus:outline-none">
