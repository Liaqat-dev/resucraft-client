...
const LaptopMockup: React.FC = () => (
    <div style={{position: "relative", width: "100%"}}>
        <div style={{
            ...
            <div style={{display: "flex", height: 130, background: "#060d1a", overflow: "hidden"}}>
                <div style={{
                    ...
                    <div style={{
                        height: 10,
                        background: "rgba(192,154,58,0.3)",
                        borderRadius: 4,
                        marginBottom: 8,
                        width: "85%"
                    }}/>
                    {["Personal", "Education", "Experience", "Skills", "Projects", "Certs"].map((s, i) => (
                        <div key={s} style={{
                            ...
                            <div style={{
                                height: 3,
                                width: `${[70, 55, 80, 65, 50, 58][i]}%`,
                                background: i === 2 ? "rgba(192,154,58,0.55)" : "rgba(255,255,255,0.12)",
                                borderRadius: 2,
                                margin: "2px 5px"
                            }}/>
                        </div>
                ...
                <div style={{flex: 1.2, padding: 10, borderRight: "1px solid rgba(255,255,255,0.06)"}}>
                    ...
                    <div style={{
                        height: 20,
                        background: "linear-gradient(135deg,rgba(192,154,58,0.25),rgba(8,145,178,0.15))",
                        borderRadius: 5,
                    ...
                    <div style={{display: "flex", gap: 3, marginTop: 5}}>
                        {[{l: "ATS", c: "#22c55e"}, {l: "Keywords", c: "#0891b2"}, {
                            l: "Format",
                            c: "#C09A3A"
                        }].map(x => (
                            <span key={x.l} style={{
                ...
                <div style={{flex: 1, padding: 8}}>
                    <div style={{
                        ...
                        {[75, 60, 85, 55, 70].map((w, i) => <div key={i} style={{
                            height: 4,
                            background: "#94a3b8",
                            borderRadius: 1,
                            width: `${w}%`
                        ...
                        {[65, 50, 80].map((w, i) => <div key={i} style={{
                            height: 4,
                            background: "#94a3b8",
                            borderRadius: 1,
                            width: `${w}%`
        ...
        <div style={{
            height: 10,
            background: "linear-gradient(180deg,#14213a,#0f1a2e)",
            borderRadius: "0 0 4px 4px",
            margin: "0 -4px"
        }}/>
        <div style={{
            height: 5,
            background: "linear-gradient(180deg,#0b1422,#08101a)",
    ...
    <div style={{
        ...
        <div style={{
            ...
            <div style={{flex: 1}}>
                ...
                <p style={{margin: 0, fontSize: 8, color: "#00c9be", fontFamily: "'DM Sans', sans-serif"}}>● Live ·
                    Phase 3: Behavioral</p>
            </div>
            <div style={{display: "flex", alignItems: "center", gap: 2}}>
                {[3, 6, 4, 8, 5, 7, 3].map((h, i) => <div key={i} style={{
                    width: 2,
                    height: h + 4,
                    borderRadius: 1,
                    background: "#7c3aed",
            ...
            <div style={{display: "flex", gap: 6}}>
                ...
                <div style={{
                    ...
                    <p style={{
                        ...
                        lineHeight: 1.5,
                        fontFamily: "'DM Sans', sans-serif"
                    }}>Describe a time you had to make a critical technical decision under pressure. What was your
                        process?</p>
                </div>
            </div>
            <div style={{display: "flex", justifyContent: "flex-end"}}>
                <div style={{
                    background: "rgba(192,154,58,0.13)",
                    ...
                    <p style={{
                        ...
                        lineHeight: 1.5,
                        fontFamily: "'DM Sans', sans-serif"
                    }}>I built a risk matrix and chose dual-write — zero downtime, 40% fewer errors in production.</p>
                </div>
            </div>
            <div style={{display: "flex", gap: 6}}>
                <div style={{
                    ...
                    alignItems: "center",
                    justifyContent: "center"
                }}><Lightbulb size={8} color="white"/></div>
                <div style={{
                    ...
                    <p style={{
                        ...
                        lineHeight: 1.45,
                        fontFamily: "'DM Sans', sans-serif"
                    }}>Good use of metrics. Expand on team alignment.</p>
                </div>
            </div>
        </div>
    </div>
...
const PosterInner: React.FC = () => (
    <div id="resucraft-poster" style={{
        ...
        <div style={{
            ...
            borderRadius: "50%",
            filter: "blur(100px)",
            background: "rgba(192,154,58,0.09)",
            top: -100,
            left: -100,
            pointerEvents: "none"
        }}/>
        ...
        <div style={{
            ...
            borderRadius: "50%",
            filter: "blur(90px)",
            background: "rgba(192,154,58,0.07)",
            top: 1900,
            right: -80,
            pointerEvents: "none"
        }}/>
        ...
        <div style={{
                ...
                {[
                    {
                        ...
                        desc: "Paste any job description — Gemini AI crafts a perfectly tailored, ATS-optimized resume in under 60 seconds with 50+ customizable templates.",
                        color: T.accentLight,
                        pale: T.accentPale,
                    ...
                    {
                        icon: <Mic size={18}/>,
                        title: "Live Voice Mock Interview",
                        desc: "Real-time AI voice interviews via WebSocket. Gemini 2.5 Flash conducts structured 5-phase sessions with live speech-to-text transcription.",
                        color: T.purple,
                        pale: T.purplePale,
                    ...
                    },
                    {
                        ...
                        desc: "Smart keyword matching and professional formatting ensure 60%+ higher resume pass-through rates across all major Applicant Tracking Systems.",
                        color: T.teal,
                        pale: T.tealPale,
                    ...
                    },
                    {
                        ...
                        desc: "Post-interview report with 4-dimension scoring — Overall, Communication, Technical, Relevance — plus specific strengths and improvements.",
                        color: T.green,
                        pale: T.greenPale,
                ...
                {[
                    {
                        ...
                        desc: "Add personal info, education, work experience, projects, skills, and certifications. ResuCraft stores everything securely.",
                        color: T.accentLight,
                        pale: T.accentPale,
                        border: T.borderAccent
                    },
                    {
                        ...
                        desc: "Copy any JD from LinkedIn, Indeed, or a company site. Our AI parses every keyword and required skill automatically.",
                        color: T.teal,
                        pale: T.tealPale,
                        border: "rgba(8,145,178,0.3)"
                    },
                    {
                        ...
                        desc: "Browse 50+ ATS-friendly templates. Preview in real time as AI populates all sections with tailored, role-specific content.",
                        color: T.purple,
                        pale: T.purplePale,
                        border: "rgba(124,58,237,0.3)"
                    },
                    {
                        ...
                        desc: "Export as a polished PDF — keyword-matched, correctly formatted, guaranteed to pass ATS filters and reach human recruiters.",
                        color: T.green,
                        pale: T.greenPale,
                        border: "rgba(22,163,74,0.3)"
                    },
                    ...
                    <div key={s.n} style={{
                        ...
                        <div style={{
                            position: "absolute",
                            inset: 0,
                            background: `radial-gradient(ellipse at 0% 0%, ${s.pale}, transparent 55%)`,
                            pointerEvents: "none"
                        }}/>
                        <div style={{
                            display: "inline-flex",
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            height: 38,
                            borderRadius: "50%",
                            background: `conic-gradient(${T.accent} 84%, #e2e8f0 0)`,
                            display: "flex",
                            alignItems: "center",
                            justifyContent: "center",
                            flexShrink: 0
                ...
                {[
                    {
                        ...
                        label: "Live Voice",
                        sub: "Bidirectional real-time audio",
                        color: T.purple
                    },
                    {
                        icon: <Waves size={16}/>,
                        label: "Speech-to-Text",
                        sub: "Auto candidate transcription",
                        color: T.teal
                    },
                    {
                        icon: <Shield size={16}/>,
                        label: "JWT Auth",
                        sub: "Secure WebSocket sessions",
                        color: T.accentLight
                    },
                    {
                        icon: <BarChart2 size={16}/>,
                        label: "4 Score Dims",
                        sub: "Detailed performance report",
                        color: T.green
                    },
                ].map(x => (
            ...
            <div style={{marginBottom: 20}}>
                ...
                <div style={{
                    ...
                    {[{label: "MongoDB", dot: T.green}, {label: "Express", dot: T.textSub}, {
                        label: "React",
                        dot: T.blue
                    }, {label: "Node.js", dot: "#15803d"}].map((item, i) => (
            ...
            <div style={{
                textAlign: "center",
                padding: "14px 22px",
                background: `linear-gradient(135deg,${T.accentPale},rgba(8,145,178,0.05))`,
                border: `1px solid ${T.borderAccent}`,
                borderRadius: 14,
                marginBottom: 18,
                position: "relative",
                ...
                <p style={{
                    ...
                    fontSize: 10,
                    color: T.textMuted
                }}>Department of Computer Science · Lahore Garrison University</p>
                ...
                <div style={{display: "flex",  gap: 9,} } className={'justify-around '}>
                    {[
                        {name: "Liaqat Ali", roll: "Fa22-BSCS-096", color: T.accentLight},
                        {name: "Alishba Ramzan", roll: "Fa22-BSCS-395", color: T.accentLight},
                    ].map(m => (
                        <div className={'flex gap-3'}>
                            <div style={{
                                ...
                                height: 50,
                                borderRadius: "10%",
                                background: `linear-gradient(135deg,${m.color}40,${m.color}18)`,
            ...
            <div style={{marginTop: "auto", paddingBottom: 20}}>
                <div style={{
                    height: 1,
                    background: `linear-gradient(90deg,transparent,${T.accent}60,${T.teal}50,${T.accent}60,transparent)`,
                    marginBottom: 10
                }}/>
                ...
                <div style={{display: "flex", alignItems: "center", justifyContent: "center", gap: 14}}>
                    <div style={{textAlign: "left"}}>
                        ...
                        }}>Department of Computer Science · BS Computer Science · FYP Exhibition 2026</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div style={{
            position: "absolute",
            inset: 0,
            background: "linear-gradient(150deg,rgba(255,255,255,0.5) 0%,transparent 38%)",
            pointerEvents: "none"
        }}/>
    </div>
);
        ...
        <>
            ...
            <div className="poster-root">
                <div ref={posterRef} className="poster-frame"
                     style={{width: POSTER_W, borderRadius: 2, overflow: "hidden", flexShrink: 0}}>
                    <PosterInner/>
                </div>
