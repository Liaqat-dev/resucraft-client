        ...
        <div style={{minHeight: '100vh', background: theme.bg, fontFamily: "'DM Sans', sans-serif"}}>
            ...
            >
                ...
                <div style={{
                    ...
                    >
                        Build a Resume That{' '}
                        <em style={{color: theme.accentLight, fontStyle: 'italic', display: 'block'}}>Gets You
                            Hired</em>
                    </h1>
                    ...
                    <div style={{
                        ...
                        {!user && !loading ?
                            <Link to={"/auth/sign-up"} className="rc-btn">
                                ...
                                style={{color: theme.accentLight, position: 'relative', zIndex: 1}}>↗</span>
                            </Link> :
                            <Link to={"/profile"} className="rc-btn">
                                Start Building for Free <span
                                style={{color: theme.accentLight, position: 'relative', zIndex: 1}}>↗</span>
                            </Link>
                        }
                ...
                <div style={{maxWidth: '80rem', margin: '0 auto', padding: '0 1.5rem'}}>
                    <div style={{textAlign: 'center', marginBottom: '3.5rem'}} data-aos="fade-up">
                        <div style={{
                            ...
                            {[1, 2, 3, 4, 5].map(i => <Star key={i} size={16} style={{
                                color: theme.accentLight,
                        ...
                        {testimonials.map((t, i) => (
                            ...
                            >
                                <div style={{
                                    ...
                                    {[1, 2, 3, 4, 5].map(j => <Star key={j} size={12} style={{
                                        color: theme.accentLight,
                                        fill: theme.accentLight
                                    }}/>)}
                                </div>
            ...
            {/* ── CTA ── */}
            <section style={{background: theme.bgDeep, padding: '5rem 0', position: 'relative', overflow: 'hidden'}}
                     className="rc-dot-bg">
                <div className="rc-glow-gold"
                     style={{width: '28rem', height: '28rem', bottom: '-8rem', right: '-4rem', opacity: 0.4}}/>
                <div style={{
                    maxWidth: '48rem',
                    margin: '0 auto',
                    padding: '0 1.5rem',
