        ...
        <div className="col-span-12 md:col-span-6 card">
          ...
          <div className="card-body">
            <div className="text-sm">
              <div>
                <label htmlFor="logo">
                  <div className="inline-flex items-center justify-center overflow-hidden bg-gray-100 border border-gray-200 rounded-smcursor-pointer dark:bg-dark-850 dark:border-dark-800 size-32">
                    {imageUrl ? (
                      <img
                        src={imageUrl}
