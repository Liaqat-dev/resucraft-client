          ...
          <div className="card-body">
            <div className="relative">
              ...
              <button
                ...
                className="absolute inset-y-0 flex items-center p-0 text-gray-500 dark:text-dark-500 ltr:right-3 dark:hover:text-primary-500 hover:text-primary-500 focus:text-primary-500 dark:focus:text-primary-500 rtl:left-3 focus:outline-none btn focus:outline-0"
              >
