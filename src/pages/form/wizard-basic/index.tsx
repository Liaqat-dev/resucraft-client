  ...
  const handleImageChange = (event: ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      reader.onload = () => {
        ...
        setForm((prev) => ({ ...prev, imageForm: imageUrl }));
                          ...
                          {step === 1 && (
                            <>
                              <div className="mb-5 text-center">
                                ...
                                <label
                                  htmlFor="fileInput"
                                  className="items-center justify-between inline-block px-4 py-2 font-medium text-left text-gray-500 border border-gray-200 rounded-lg shadow-xs cursor-pointer dark:border-dark-800 dark:text-dark-500 inline-flex focus:outline-none hover:bg-gray-100 dark:hover:bg-dark-850"
                                >
                                  <Camera className="inline-flex shrink-0 -mt-1 ltr:mr-1 rtl:ml-1 size-5" />
                                  Browse Photo
                                </label>
