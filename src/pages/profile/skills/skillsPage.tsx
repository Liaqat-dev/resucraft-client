...
import { skillService, Skill } from "../../../services/skills.service.ts";
        ...
        <div className="max-w-4xl mx-auto p-8 space-y-10">
            ...
            {categories.map((category) => {
                ...
                return (
                    <div
                        key={category}
                        className="bg-white shadow-lg rounded-2xl p-6 border border-gray-100 transition hover:shadow-xl"
                    >
                        {/* Header */}
