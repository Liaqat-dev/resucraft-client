...
import {ticketsData} from "@src/data";
...
const HelpCenterPage = () => {
    ...
    useEffect(() => {
        const data: TicketCategory[] = ticketsData;
        setTickets(data);
    ...
    const [showNewTicketsModal, setShowNewTicketsModal] =
        useState<boolean>(false);

    const onSubmit = (data: FormValues, onClose: () => void) => {
            ...
            <div className="grid grid-cols-12 gap-x-space">
                ...
                <div className="col-span-12 xl:col-span-4 2xl:col-span-3">
                    <div className="card">
                        <div className="card-body">
                            ...
                            <div className="relative group/form">
                                ...
                                />
                                <button
                                    className="absolute inset-y-0 flex items-center text-gray-500 dark:text-dark-500 ltr:left-3 rtl:right-3 ltr:group-[&.right]/form:right-3 rtl:group-[&.right]/form:left-3 ltr:group-[&.right]/form:left-auto rtl:group-[&.right]/form:right-auto focus:outline-none">
                                    <Search className="size-4"></Search>
                                </button>
                            </div>
                            <div className="h-auto lg:h-[calc(100vh_-_28rem)]" data-simplebar>
                                <ul className="px-1 my-5 space-y-3">
                                    {tickets.map((ticket) => (
                                        <li key={ticket.category}>
                                            <Link
                                                to="#!"
                                                className={`block px-4 py-2 font-medium rounded-md text-gray-500 dark:text-dark-500 ${activeTicket === ticket.category ? "bg-primary-500/10 text-primary-500 outline outline-primary-500/20" : "hover:text-primary-500 dark:hover:text-primary-500"} transition ease-linear duration-200 text-sm`}
                                                onClick={() => flattenTickets(ticket.category)}
                                            >
                                                {ticket.category}{" "}
                                                {ticket.count ? (
                                                    <span
                                                        className="py-1 leading-none align-middle badge badge-primary ltr:ml-1 rtl:mr-1">
                            {ticket.count}
                          </span>
                                                ) : (
                                                    ""
                  ...
                  <span className="absolute inset-0 overflow-hidden rounded-xl">
                    <span
                        className="absolute inset-0 rounded-xl bg-[image:radial-gradient(75%_100%_at_50%_0%,rgba(56,189,248,0.6)_0%,rgba(56,189,248,0)_75%)] opacity-0 transition-opacity duration-500 group-hover/effect:opacity-100"></span>
                  </span>
                                    <span>
                    Contact Us
                ...
                <div className="col-span-12 xl:col-span-8 2xl:col-span-9">
                                    ...
                                    (filter) => (
                                        <li key={filter}>
                                            <button
                                                ...
                                                className={`nav-item [&.active]:after:opacity-100 [&.active]:after:w-full [&.active]:text-primary-500 ${activeFilter === filter ? "active" : ""}`}
                                            >
                                                {filter}
                                            </button>
                                        </li>
                  ...
                  <span className="icon">
                                        ...
                                        <div className="card-body">
                                            <div className="flex items-center gap-5 mb-4">
                                                <h6 className="underline grow">
                                                    <Link to="#!" onClick={() => showTicket(ticket)}>
                                                        Ticket #{ticket.id}
                                                    </Link>
                                                </h6>
                    ...
                    <span className="text-gray-500 dark:text-dark-500">
                      ...
                      <Link to="#!">{ticketDetails.author}</Link>
                    </span>
                                        <span className="text-gray-500 dark:text-dark-500">
