...
import {appendDarkModeClass, changeHTMLAttribute, getPreviousStorageData, setNewThemeData,} from "./utils";
...
export const changeModernNavigation =
    (Navigation: MODERN_NAVIGATION) => async (dispatch: any, getState: any) => {
        try {
...
export const changeDarkModeClass =
    (darkModeClass: DARK_MODE_CLASS) => async (dispatch: any) => {
        try {
